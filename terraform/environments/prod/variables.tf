...
variable "node_group_min_size" {
  ...
  type        = number
  default     = 2  # Increased for production
}
...
variable "node_group_instance_types" {
  ...
  type        = list(string)
  default     = ["t3.large"]  # More powerful instance type for production
}
...
variable "db_instance_class" {
  ...
  type        = string
  default     = "db.t3.medium"  # More powerful instance class for production
}
